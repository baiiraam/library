...
def create_book(title: None | str = None, author: str | None = None, year: None | int = None, is_read: bool | None = None, genre: str | None = None):
    global book_count
    # book_count += 1
...
def main():
    book1 = create_book(title="Karamazov brothers", author='Dostoyevski')
    print(is_classic(book1))
    library = []
    add_book(create_book(title="Ali Nino", author="Qurban Seid", year=1937, genre="Roman"))
    add_book(create_book(title="1984", author="George Orwell", year=1949, genre="Distopia"))
    add_book(create_book(title="Sapiens", author="Yuval Noah Harari", year=2011, genre="Tarix"))
